...
public class AmIMonitoringDataRepositoryServiceWrapper<Type extends IMonitoringDataModel<?, ?>> extends
     ...
     * (non-Javadoc)
     *
     * @see IMonitoringDataRepository#getLastIds(de.atb.context.common.util.ApplicationScenario, java.lang.Class, int)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see IMonitoringDataRepository#getLastIds(de.atb.context.common.util.BusinessCase, java.lang.Class, int)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see IMonitoringDataRepository#getLastIds(de.atb.context.common.util.ApplicationScenario, java.lang.Class, de.atb.context.common.util.TimeFrame)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see IMonitoringDataRepository#getLastIds(de.atb.context.common.util.BusinessCase, java.lang.Class, de.atb.context.common.util.TimeFrame)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see IMonitoringDataRepository#getMonitoringData(de.atb.context.common.util.ApplicationScenario, java.lang.Class, int)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see IMonitoringDataRepository#getMonitoringData(de.atb.context.common.util.BusinessCase, java.lang.Class, int)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see IMonitoringDataRepository#getMonitoringData(de.atb.context.common.util.BusinessCase, java.lang.Class, java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see IMonitoringDataRepository#executeSparqlSelectQuery(de.atb.context.common.util.BusinessCase, java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see IMonitoringDataRepository#executeSparqlUpdateQuery(de.atb.context.common.util.BusinessCase, java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see IMonitoringDataRepository#executeSparqlUpdateQueries(de.atb.context.common.util.BusinessCase, java.lang.String[])
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see IMonitoringDataRepository#reset(de.atb.context.common.util.BusinessCase)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see de.atb.context.persistence.common.IPersistenceUnit#removePersistencePreProcessor(de.atb.context.common.util.ApplicationScenario, java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see de.atb.context.persistence.common.IPersistenceUnit#removePersistencePostProcessor(de.atb.context.common.util.ApplicationScenario, java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see de.atb.context.persistence.common.IPersistenceUnit#triggerPreProcessors(de.atb.context.common.util.ApplicationScenario, de.atb.context.common.util.IApplicationScenarioProvider)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see de.atb.context.persistence.common.IPersistenceUnit#triggerPostProcessors(de.atb.context.common.util.ApplicationScenario, de.atb.context.common.util.IApplicationScenarioProvider)
     */
    @Override
