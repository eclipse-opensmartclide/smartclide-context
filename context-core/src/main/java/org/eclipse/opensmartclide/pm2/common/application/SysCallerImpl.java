...
import org.eclipse.opensmartclide.pm2.common.io.POKindCoreServiceAppScenConfAMs;
import org.eclipse.opensmartclide.pm2.common.io.POKindCoreServiceAppScenConfAMsImpl;
import org.eclipse.opensmartclide.pm2.common.io.POKindCoreServiceMonitoringConfAMs;
import org.eclipse.opensmartclide.pm2.common.io.POKindCoreServiceMonitoringConfAMsImpl;
import org.eclipse.opensmartclide.pm2.common.io.POKindCoreServicesConfAMs;
import org.eclipse.opensmartclide.pm2.common.io.POKindCoreServicesConfAMsImpl;

import static org.eclipse.opensmartclide.pm2.common.application.ObjectKinds.POKind_CoreService_AppScenConf;
import static org.eclipse.opensmartclide.pm2.common.application.ObjectKinds.POKind_CoreService_Monitoring_conf;
import static org.eclipse.opensmartclide.pm2.common.application.ObjectKinds.POKind_CoreServices_conf;
import static org.eclipse.opensmartclide.pm2.common.application.ObjectKinds.POKind_X;
...
public class SysCallerImpl implements SysCaller {
    ...
    private void initializeProtectedObjects() {
        for (POinitial aPoi : poi) {
            ProtectedObject po;
            po = new ProtectedObject(aPoi.poname, aPoi.poperms, aPoi.pokind, aPoi.ponode, aPoi.popath);
