...
public class KMBApi {
    ...
    private static final String BASE_URL = "https://apiproseco.repcon.es/repcon/r_call/proseco_kmb_api/_/r/";
    ...
    private void connect() throws ContextFault {
        try {
            URL theUrl = new URL(BASE_URL);
    ...
    private boolean writeWentOK() throws IOException {
     ...
     * Knowledge DATABASE.
     *
     * @param id Unique identifier of the element (for instance unique
    ...
    /**
     * @param id       (e.g. PES_example_12345)
     * @param jsonText (e.g. {\
    ...
    /**
     * @param id       (e.g. PES_example_12345)
     * @param clazz    (e.g. kmb_specific_subclass)
     * @param jsonText (e.g. {\
     *                 "\"PES_example_12345\"\":{},\"\"Machine_example_234\"\":{},\\\n\"\"selected
     *                 _ S e n s o r s \ " \ " : [ \ \ \ n \ \ \ t {
     *                 \"\"name\"\":\"\"Actor
     ...
     * @param jsonText Text containing the properties of the element in Json format.
     ...
     *                 identifier of the PES). To be sent between single quotes.
     *                 (e.g. ID_PES_123456777)
     * @param clazz    Name of the class of the element, with the namespace prefix.
     *                 For example:
     *                 'ProSEco_Ontological_Model:PES_Deployable_Solution'. To be
     *                 sent between single quotes. (e.g. kmb_specific_subclass)
     * @param jsonText jsonText Text containing the properties of the element in Json
     ...
     *                 identifier of the PES). To be sent between single quotes.
     *                 (e.g. ID_PES_123456777)
     * @param property The name of the property. To be sent between single quotes.
     *                 (e.g. \"\"Status\"\")
     * @return String
     * @throws ContextFault Thrown in any case of error
     */
     ...
     *
     * @param clazz Name of the class of the elements to be retrieved, with the
